...
export async function middleware(request: NextRequest) {
  ...
  if (pathname === '/' || pathname.startsWith('/fire') || pathname.startsWith('/police') || pathname.startsWith('/public-works') || pathname.startsWith('/dept/') || pathname.startsWith('/print/fire-school') || pathname.startsWith('/kiosk') || pathname.startsWith('/digest-ack') || pathname.startsWith('/board-guest') || pathname.startsWith('/hose-testing')) {
