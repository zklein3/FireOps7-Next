  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-white">
      ...
      <div className="shrink-0 px-5 py-4 border-b border-zinc-200 bg-zinc-50">
        <p className="text-xs font-semibold uppercase tracking-wide text-zinc-400">Incident Signature</p>
        <p className="text-xl font-bold text-zinc-900 mt-0.5">{memberName}</p>
        <p className="text-sm text-zinc-500">{incidentLabel}</p>
        <p className="text-xs text-zinc-400 mt-1">
          By signing, you confirm that you responded to and were present at this incident.
        </p>
      </div>
